...
import { MessageCircle, Mail, HelpCircle, ArrowRight, Clock } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          >
            ...
            <span className="text-white/70 text-xs sm:text-sm font-medium">Support</span>
          </motion.div>
                  ...
                  <div className="group p-4 sm:p-6 lg:p-8 rounded-2xl bg-white/[0.03] border border-white/[0.08] overflow-hidden hover:bg-white/[0.06] hover:border-white/[0.12] transition-all duration-300 backdrop-blur-sm h-full relative">
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      ...
                      <div className="flex flex-col space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                        <div className={`inline-flex p-2.5 sm:p-3 rounded-xl bg-gradient-to-br ${option.color} border border-white/20 group-hover:scale-105 transition-transform duration-200 self-start`}>
                          <Icon className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                        </div>
                        
                        <div className="space-y-2 sm:space-y-3">
                          <h3 className="text-lg sm:text-xl font-semibold text-white">{option.title}</h3>
                          <p className="text-white/70 leading-relaxed text-sm sm:text-base">{option.description}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2 text-blue-400 font-medium hover:text-blue-300 transition-colors group/link self-start mt-auto">
                        <span className="text-xs sm:text-sm">{option.cta}</span>
