...
// Lazy load heavy modal and toolbar components
const ExportModal = dynamic(() => import("@/components/ui/modal/ExportModal"), { ssr: false });
const ImportModal = dynamic(() => import("@/components/ui/modal/ImportModal"), { ssr: false });
const FileManagerModal = dynamic(() => import("@/components/ui/modal/FileManagerModal"), { ssr: false });
const GoogleDrivePickerModal = dynamic(() => import("@/components/ui/modal/GoogleDrivePickerModal"), { ssr: false });
const MainToolbar = dynamic(() => import("@/components/toolbar/MainToolbar"), { ssr: false });
const FloatingStickyNoteToolbar = dynamic(() => import("@/components/toolbar/stickynote/FloatingStickyNoteToolbar"), { ssr: false });
const FloatingFrameToolbar = dynamic(() => import("@/components/toolbar/frame/FloatingFrameToolbar"), { ssr: false });
const FloatingTextToolbar = dynamic(() => import("@/components/toolbar/text/FloatingTextToolbar"), { ssr: false });
const FloatingShapesToolbar = dynamic(() => import("@/components/toolbar/shape/FloatingShapesToolbar"), { ssr: false });
const CollaborationPanel = dynamic(() => import("@/components/layout/CollaborationPanel"), { ssr: false });
...
// More lazy loaded modals
const RenameBoardModal = dynamic(() => import("@/components/ui/modal/RenameBoardModal"), { ssr: false });
const InviteCollaboratorsModal = dynamic(() => import("@/components/ui/modal/InviteCollaboratorsModal"), { ssr: false });
const UserManagementModal = dynamic(() => import("@/components/ui/modal/UserManagementModal"), { ssr: false });
const SuccessModal = dynamic(() => import("@/components/ui/modal/SuccessModal"), { ssr: false });
import { toast } from "sonner";
const CanvasHeader = dynamic(() => import("@/components/layout/header/utils/CanvasHeader"), { ssr: false });
import {
  BoardProvider,
  useBoardContext,
...
// Simplified components without expensive memoization
