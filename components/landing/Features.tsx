...
const Features = () => {
  ...
  const features = [
    {
      id: 0,
      title: LANDING_CONTENT.features.drawing.title,
      description: LANDING_CONTENT.features.drawing.description,
      icon: PenTool,
      color: "from-blue-600 to-blue-500",
      gradient: "from-blue-600/20 to-blue-500/20",
      accent: "blue",
      details: LANDING_CONTENT.features.drawing.details,
      demo: "#",
      stats: { users: "—", rating: "—", time: "—" },
    },
    {
      id: 1,
      title: LANDING_CONTENT.features.collaboration.title,
      description: LANDING_CONTENT.features.collaboration.description,
      icon: Users,
      color: "from-blue-500 to-blue-400",
      gradient: "from-blue-500/20 to-blue-400/20",
      accent: "blue",
      details: LANDING_CONTENT.features.collaboration.details,
      demo: "#",
      stats: { users: "—", rating: "—", time: "Real-time" },
    },
    {
      id: 2,
      title: LANDING_CONTENT.features.canvas.title,
      description: LANDING_CONTENT.features.canvas.description,
      icon: Layers,
      color: "from-blue-600 to-blue-500",
      gradient: "from-blue-600/20 to-blue-500/20",
      accent: "blue",
      details: LANDING_CONTENT.features.canvas.details,
      demo: "#",
      stats: { users: "—", rating: "—", time: "Unlimited" },
    },
    {
      id: 3,
      title: LANDING_CONTENT.features.crossPlatform.title,
      description: LANDING_CONTENT.features.crossPlatform.description,
      icon: Globe,
      color: "from-blue-500 to-blue-400",
      gradient: "from-blue-500/20 to-blue-400/20",
      accent: "blue",
      details: LANDING_CONTENT.features.crossPlatform.details,
      demo: "#",
      stats: { users: "—", rating: "—", time: "Any device" },
    },
    {
      id: 4,
      title: LANDING_CONTENT.features.security.title,
      description: LANDING_CONTENT.features.security.description,
      icon: Shield,
      color: "from-blue-600 to-blue-500",
      gradient: "from-blue-600/20 to-blue-500/20",
      accent: "blue",
  ...
  return (
    <section className="relative py-12 sm:py-16 lg:py-20 pb-0 bg-[#0A0A0B] overflow-hidden">
      {/* Background Elements */}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(124, 58, 237, 0.3) 0%, rgba(124, 58, 237, 0.08) 50%, transparent 70%)",
          filter: "blur(80px)",
        }}
        animate={{
          ...orbAnimation,
      ...
      <motion.div
        ...
        animate={{
          ...orbAnimation,
          transition: { ...orbAnimation.transition, delay: 4 },
        }}
      />
                ...
                <div className="flex flex-col space-y-4 sm:space-y-6">
                  ...
                  <div className="flex flex-col space-y-3 sm:space-y-4">
                    ...
                    <p className="text-white/70 leading-[1.6]">
                      Express ideas naturally with customizable tools and
                  ...
                  >
                    {features[0].details.slice(0, 3).map((detail, index) => (
                      ...
                      >
                        ...
                        <span className="text-white/60 text-sm leading-[1.5]">
                          {detail}
                        </span>
                      </motion.div>
                    ))}
                ...
                <div className="flex flex-col space-y-3 sm:space-y-4">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <p className="text-white/60 text-sm leading-[1.6]">
                      See exactly where teammates are working with live cursor
                      tracking and instant sync.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-3 sm:space-y-4">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <p className="text-white/60 text-xs leading-[1.5]">
                      Navigate and organize large, complex boards with infinite
                      zoom and layer management.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="flex flex-col space-y-3 sm:space-y-4">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <p className="text-white/60 text-sm leading-[1.6]">
                      Work seamlessly across all devices with browser-based
                      access and mobile optimization.
                    </p>
                  </div>
                </div>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="flex flex-col space-y-3 sm:space-y-4">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <p className="text-white/60 text-xs leading-[1.5]">
                      Enterprise-grade security with SOC 2 compliance and
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <motion.p
                variants={itemVariants}
                className="text-white/70 max-w-lg leading-[1.6] text-sm sm:text-base text-center"
              >
                Everything you need to create, collaborate, and bring your ideas
          ...
          >
            {tools.map((tool, index) => (
              ...
              >
                <div
                  className={`inline-flex p-3 rounded-lg ${tool.bgColor} border border-blue-600/20 group-hover:bg-blue-600/15 transition-colors`}
                >
