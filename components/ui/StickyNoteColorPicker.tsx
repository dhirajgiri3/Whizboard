  ...
  return (
    ...
    >
        ...
        {colors.map((color) => (
          ...
          >
            ...
            <div 
              ...
              style={{
                background: `linear-gradient(135deg, white 0%, transparent 50%, ${getBorderColor(color)}20 100%)`
              }}
            />
      ...
      <div className="flex gap-2 mt-4">
        <button
          onClick={() => onColorSelectAction(colors[Math.floor(Math.random() * colors.length)])}
...
export function useStickyNoteColorPicker() {
  ...
  const [selectedColor, setSelectedColor] = useState(getStickyNoteColorPalette()[0]);
